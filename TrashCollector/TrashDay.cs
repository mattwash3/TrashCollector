...
namespace TrashCollector
{
    ...
    {
        TrashDay monday = new TrashDay("Monday");
        TrashDay tuesday = new TrashDay("Tuesday");
        TrashDay wednesday = new TrashDay("Wednesday");
        TrashDay thursday = new TrashDay("Thursday");
